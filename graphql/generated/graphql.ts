...
export type Mutation = {
  ...
  removeAuthorOnTrip: AuthorsOnTrips;
  sendInvite: Invite;
  token: Scalars['Boolean'];
  updateActiveElement: ActiveElement;
  updateActivity: Activity;
  updateAuthorOnTrip: AuthorsOnTrips;
...
export type MutationUpdateAuthorOnTripArgs = {
  email: Scalars['String'];
  tripId: Scalars['ID'];
};
...
export type AuthorsOnTripsQuery = { __typename?: 'Query', authorsOnTrips: Array<{ __typename?: 'AuthorsOnTrips', id: string, role: TripRole, user: { __typename?: 'User', id: string, email: string }, trip: { __typename?: 'Trip', id: string, name: string } }> };
